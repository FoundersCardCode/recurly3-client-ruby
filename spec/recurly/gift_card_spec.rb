...
describe GiftCard do
  let(:gift_card) {
    ...
    Recurly2::GiftCard.find 2004005808969875135
  }

  let(:gift_cards) {
    stub_api_request :get, 'gift_cards', 'gift_cards/index-200'
    Recurly2::GiftCard.all
  }
  ...
  describe "#find" do
    it "should find a gift card" do
      gift_card.must_be_instance_of Recurly2::GiftCard
    end
    ...
    it "should parse all the gift card fields" do
      ...
      delivery.must_be_instance_of Recurly2::Delivery
  ...
  describe "#to_xml" do
    ...
    describe "when adding a top level billing info" do
      let(:gift_card) {
        Recurly2::GiftCard.new(
          billing_info: Recurly2::BillingInfo.new(token_id: '1234')
        )
      }

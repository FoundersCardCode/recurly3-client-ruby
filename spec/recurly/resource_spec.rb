...
HTML
        ...
        proc { Resource.find(123) }.must_raise Recurly3::Error
      end
    end
...
XML
    ...
    describe ".has_many" do
      before do
        Recurly3.const_set :Reason, Class.new(Resource)
        resource.has_many :reasons
      end

      after do
        Recurly3.send :remove_const, :Reason
      end
    ...
    describe ".has_one and .belongs_to" do
      before do
        Recurly3.const_set :Day, Class.new(Resource)
        resource.has_one :day
        Day.belongs_to :resource
      end

      after do
        Recurly3.send :remove_const, :Day
      end
...
XML
    ...
    describe "saving" do
      ...
      describe "invalid records" do
        before do
          Recurly3.const_set :Child, resource
        ...
        after do
          Recurly3.send :remove_const, :Child
        end

...
describe GiftCard do
  let(:gift_card) {
    ...
    Recurly3::GiftCard.find 2004005808969875135
  }

  let(:gift_cards) {
    stub_api_request :get, 'gift_cards', 'gift_cards/index-200'
    Recurly3::GiftCard.all
  }
  ...
  describe "#find" do
    it "should find a gift card" do
      gift_card.must_be_instance_of Recurly3::GiftCard
    end
    ...
    it "should parse all the gift card fields" do
      ...
      delivery.must_be_instance_of Recurly3::Delivery
  ...
  describe "#to_xml" do
    ...
    describe "when adding a top level billing info" do
      let(:gift_card) {
        Recurly3::GiftCard.new(
          billing_info: Recurly3::BillingInfo.new(token_id: '1234')
        )
      }
